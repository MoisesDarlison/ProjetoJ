   ...
   */
    async create(request, response) {
        try {
            ...
            const { productId, quantity, validAt, costPrice, salesPrice, batch, isSaleOff, observation } = request.body
            ...
            const purchase = await purchaseModel.setPurchase(productId, quantity, validAt, costPrice, salesPrice, batch, isSaleOff, observation)
